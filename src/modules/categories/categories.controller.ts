...
export class CategoriesController {
  ...
  @ApiOperation({ summary: 'Permite obtener una categoría según su id' })
  @Get(':id')
  ...
  @ApiOperation({
    summary: 'Permite actualizar los datos de una categoría',
  })
  @Patch(':id')
  ...
  @ApiOperation({ summary: 'Permite eliminar una categoría según su id' })
  @Delete(':id')
